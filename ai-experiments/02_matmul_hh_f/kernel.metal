// 02_matmul_hh_f – half × half → float  (NN, execution_simdgroups<4>)
// Same tile and dispatch as 01, but the accumulator and output are float32.
// This matches the type combination used in Apple's own example in MPPTensorOpsMatMul2d.h.
//
